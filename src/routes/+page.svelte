        ...
        <div class="banner_info">
          ...
          <div class="innopolis_href">
            <div class="introduction">
              <p>
                <a href="https://www.innopolis.com/ru" target="_blank"
                  >INNOPOLIS</a
                >
              </p>
    ...
    <section class="questions">
      ...
      <div class="warning">
        ...
        <p>
          ...
          образовательных целях. Упомянутая строительная компания не существует,
          а все данные, включая контактную информацию, проекты и отзывы,
          являются вымышленными. Любое сходство с реальными компаниями или
          лицами случайно.
        </p>
      </div>
    </section>
